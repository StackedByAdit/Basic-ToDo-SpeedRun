    ...
    return (
        ...
        <div className="flex flex-col items-center justify-center p-5 gap-5 text-amber-50
         ...
         shadow-[0_0_20px_rgba(111,111,111,0.4)]" >
            <div>
                <input className="border-1 hover:scale-110 transition duration-200 active:scale-95 hover:bg-gray-800 rounded-2xl p-5" type="text" placeholder="enter username" onChange={(e) => { setUsername(e.target.value) }} value={username} />
            </div>
            <div>
            ...
            <div>
                <button className="border-1 hover:scale-110 transition duration-200 active:scale-95 hover:bg-gray-800 rounded-2xl p-5" onClick={handleSubmit}> Signup</button>
            </div>
        </div>
    )
}
